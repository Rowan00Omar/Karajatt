    ...
    <div dir="rtl" className="w-full pt-24 space-y-6 bg-white">
      ...
      <div className="flex flex-wrap gap-4 justify-center">
        <select
            ...
            className="p-2 px-4 rounded-lg border border-blue-300 bg-white text-gray-800 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 hover:bg-blue-50 transition-all"
        >
