  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        <div className="bg-white rounded-3xl shadow-xl p-6 md:p-8 mb-12 transform transition-all duration-300 hover:shadow-2xl border border-gray-100">
          <button
            onClick={() => setIsFiltersVisible(!isFiltersVisible)}
            className="w-full flex items-center justify-between p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl mb-6 hover:from-gray-100 hover:to-gray-200 transition-all duration-300 group"
          >
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-blue-600 text-white flex items-center justify-center shadow-lg shadow-blue-200 transition-transform group-hover:scale-110">
          ...
          >
            <div className="flex items-center justify-between mb-8 pb-4 border-b">
              <div className="flex items-center gap-2 text-gray-600">
                <h2 className="text-xl font-semibold">الفلاتر المتاحة</h2>
              </div>
              <button
                onClick={handleResetFilters}
                className="px-4 py-2 text-blue-600 hover:text-blue-800 text-sm font-medium hover:bg-blue-50 rounded-lg transition-colors duration-200"
              >
                إعادة تعيين الفلاتر
              </button>
            </div>
            ...
            <div className="mt-8 flex justify-center gap-4">
              <Button
                ...
                disabled={loading}
                className="w-full sm:w-auto min-w-[200px] py-4 px-8 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-medium rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 hover:scale-105 transform"
              >
                {loading ? (
