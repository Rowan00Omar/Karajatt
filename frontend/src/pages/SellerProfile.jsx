...
const SellerProfile = () => {
  ...
  if (loading)
    return <div className="text-center py-8 mt-16">جاري التحميل...</div>;
  if (error)
    return <div className="text-red-500 text-center py-8 mt-16">{error}</div>;
  if (!seller)
    return (
      <div className="text-center py-8 mt-16">لم يتم العثور على البائع</div>
    );
